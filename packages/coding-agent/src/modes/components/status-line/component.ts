...
type StatusLineLayout = "box" | "band" | "plain-full" | "plain-bottom" | "plain-right";
...
export class StatusLineComponent implements Component {
	...
	renderBottomBar(width: number, groups: "left" | "full", previewTitle?: string): string {
		return this.#buildStatusLine(width, groups === "left" ? "plain-bottom" : "plain-full", previewTitle)
			.dimmedContent;
	}
	/**
