...
export function applyStartupComposerPreferences(update: PrepaintComposerPreferences): void {
	...
	const preferences: ComposerPreferences = {
		...
		tuiMode: update.tuiMode,
		fullscreenScrollbar: update.fullscreenScrollbar,
		fullscreenCopyOnSelect: update.fullscreenCopyOnSelect,
		fullscreenExitOutput: update.fullscreenExitOutput,
