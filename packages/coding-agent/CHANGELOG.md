...
- Made the fullscreen Todo activity dock collapsible. Its compact view keeps the active todo and detached-agent count visible, while click-to-expand restores the full Todo tree without hiding the working row; the pinned Subagents jump list remains independently visible and clickable.
