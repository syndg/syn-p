...
| `app.transcript.pageUp`     | `PageUp`                                                             | Scroll the fullscreen transcript up one page                                                                                                                                          |
| `app.transcript.pageDown`   | `PageDown`                                                           | Scroll the fullscreen transcript down one page                                                                                                                                        |
| `app.transcript.top`        | `Home`                                                               | Jump to the top of the fullscreen transcript                                                                                                                                          |
| `app.transcript.bottom`     | `End`                                                                | Jump to the bottom of the fullscreen transcript                                                                                                                                       |
...
Fullscreen mode also supports `app.transcript.halfPageUp`, `app.transcript.halfPageDown`, `app.transcript.lineUp`, and `app.transcript.lineDown`. They are unbound by default. Mouse wheel scrolling detaches the viewport from new output; click `Jump to bottom (click) ↓` or press `End` to follow output again. Dragging selects transcript text, and `tui.fullscreenCopyOnSelect` controls whether mouse release copies it.
